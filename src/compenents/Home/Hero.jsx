  ...
  return (
    <div className='w-screen  h-[450px] sm:min-h-[600px] xl:min-h-[875px] bg-hero-home bg-center bg-cover bg-no-repeat '>
        <div className='w-[92%] xl:w-[86%] h-full mx-auto flex justify-center items-center flex-col'>
            <h1 className='mt-16 font-semibold text-2xl sm:text-3xl md:text-5xl xl:text-[64px] leading-[31px] sm:leading-[45px] md:leading-[60px] xl:leading-[80px] text-white text-center'>Connecting world class companies with world class global talent</h1>
